...
En un sistema embebido el controlador se ejecuta en tiempo discreto. En
este trabajo se emplea una forma incremental con derivada sobre la medición,
saturación de la salida, actualización condicional del integrador
(\emph{anti-windup}) y una zona muerta sobre el error. Estas decisiones
reducen los saltos ante cambios de referencia y los ciclos límite asociados
a la cuantización. La ley exacta, los estados internos y el orden de
operaciones se documentan en el \ref{anx:pid_ecuaciones}; las ganancias
definitivas se presentan en el Capítulo~\ref{ch:implementacion}.
