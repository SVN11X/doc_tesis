...
meta. En este trabajo se utiliza NavFn configurado con
\texttt{use\_astar=true}, por lo que la búsqueda global emplea el algoritmo
A* sobre la rejilla derivada del mapa de costos. A* ordena la expansión de
...
hasta la meta. La implementación concreta del planificador incorpora además
los costos asociados a la representación utilizada por Nav2.

Dado que en este trabajo no se reconstruyó el escalamiento interno completo
de dichos costos, no se utiliza la admisibilidad de la heurística ni la
optimalidad matemática de la ruta como criterio de validación. Para este
proyecto, la función relevante del planificador es generar una ruta global
sobre el mapa de costos que pueda ser seguida por el controlador local.
