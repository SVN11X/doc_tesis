...
$n$ hacia una celda sucesora $w$ (contigua a $n$),
\begin{equation}
g(w)=g(n)+c(n,w),
\label{eq:astar_g}
\end{equation}
 
\noindent donde $c(n,w)$ es el costo de transitar de la celda $n$ a la celda
sucesora $w$, que combina la distancia geométrica recorrida y el costo de
