...
\noindent donde $g_{\max}$ es el número máximo de generaciones. La ley lineal
específica de la Ec.~\eqref{eq:pso_inercia} corresponde a una decisión de
implementación del script. Su efecto es reducir progresivamente el peso de la
