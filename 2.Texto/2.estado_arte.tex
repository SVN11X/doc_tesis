...
interiores por su simplicidad y capacidad de giro \citep{ferreira2023differential}; los vehículos con dirección
...
carga transportada, la maniobrabilidad requerida y la complejidad del control \citep{corke2023}.
...
desconocido mientras genera su mapa \citep{thrun2005probabilistic}.
...
requerimientos de cada aplicación \citep{macenski2022ros2}.
...
incorporar reconocimiento de objetos, pero aumentan la carga de procesamiento y pueden verse afectadas por las condiciones de iluminación~\citep{tourani2022visual}. Los sensores
...
Para una plataforma diferencial de bajo costo que opera en interiores sobre un mapa de ocupación 2D, no todas las alternativas resultan igualmente
pertinentes, y la elección responde principalmente a la representación del
entorno y a la capacidad de cómputo disponible.

En la planificación global, los métodos de búsqueda sobre rejilla, como
Dijkstra y A$^*$, son los más utilizados en mapas de ocupación 2D porque
operan directamente sobre la rejilla y permiten replanificar de forma
periódica con bajo costo computacional. Los métodos basados en muestreo, como RRT y RRT$^*$, se emplean sobre todo en espacios continuos de mayor dimensión o en sistemas con restricciones de movimiento, condiciones que no aplican a
una base diferencial en 2D. Los métodos de optimización de trayectorias
mejoran la suavidad y la factibilidad de la ruta, pero agregan un costo de
cómputo que no se justifica en este tipo de plataforma
...
Nav2 es el framework de navegación de referencia en \gls{ROS2}. Su estructura
...
ámbito distinto, Autoware ofrece una pila de navegación orientada a vehículos
autónomos, con mayores requerimientos de percepción y cómputo que los de una
plataforma de interiores. También existen soluciones propietarias integradas en
robots comerciales, cuyo funcionamiento interno no siempre es accesible.

Como alternativa a estos frameworks, es posible desarrollar una arquitectura
propia, apoyándose en bibliotecas de planificación de movimiento como OMPL o
integrando los componentes mediante otros middleware robóticos. Los algoritmos
