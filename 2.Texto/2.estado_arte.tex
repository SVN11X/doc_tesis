...
El desarrollo actual de robótica móvil abarca aplicaciones en logística,
inspección, servicios, agricultura, educación e investigación
\citep{macenski2023desks}. La diversidad de aplicaciones ha dado lugar a
robots con distintas arquitecturas de locomoción. Las plataformas
diferenciales son frecuentes en interiores por su simplicidad y su capacidad
de giro sobre el eje \citep{corke2023,ferreira2023differential}. Los
...
permiten desplazamientos laterales en espacios reducidos. La elección depende de factores como el entorno, la
...
costo y su volumen de datos son mayores \citep{macenski2023desks}.
...
\citep{grisetti2007gmapping}. &
Depende de una odometría consistente y su portabilidad a \gls{ROS2} es
menor que la de las alternativas más recientes
\citep{ngoc2023efficient,macenski2023desks}. \\

Hector SLAM &
Puede operar con baja dependencia de la odometría de ruedas
\citep{kohlbrecher2011hector}. &
...
Mayor complejidad de configuración y mayor carga de procesamiento en la
comparación experimental sobre \gls{ROS2} \citep{ngoc2023efficient}. \\
...
En la planificación global, los métodos de búsqueda sobre rejilla derivan de
la formulación original de A$^*$ \citep{hart1968astar} y siguen siendo los
...
\citep{lavalle2006planning}. Los métodos de optimización de trayectorias
...
vehículos autónomos, con requerimientos de percepción y cómputo muy
superiores a los de una plataforma de interiores \citep{kato2018autoware}.
El proyecto ha evolucionado desde entonces, pero su ámbito de aplicación
sigue siendo distinto al de este trabajo. También existen soluciones propietarias integradas en
...
\citep{koenig2004gazebo,openrobotics2024gazebo}. Webots y CoppeliaSim, presentados originalmente
en \citet{michel2004webots} y \citet{rohmer2013coppeliasim}, también permiten
modelar robots y entornos tridimensionales mediante interfaces propias, mientras que Isaac
