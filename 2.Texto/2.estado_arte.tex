...
en las alternativas disponibles para plataformas de software, percepción, mapeo, navegación, exploración y simulación, considerando su grado de integración con las
plataformas de software disponibles, sus requerimientos computacionales y
su nivel de madurez.
...
\small
\begin{tabular}{P{2.4cm} P{4.3cm} P{6.9cm}}
\toprule
\textbf{Alternativa} &
...
consistente \citep{grisetti2007gmapping}. \\
...
suficientes \citep{kohlbrecher2011hector}. \\
...
periódica con bajo costo computacional. Los métodos basados en muestreo, como RRT y RRT$^*$, se emplean sobre todo en espacios continuos de mayor
dimensión o en sistemas con restricciones de movimiento. Los métodos de
optimización de trayectorias mejoran la suavidad y la factibilidad de la
ruta, a cambio de un mayor costo de cómputo
...
plataforma de interiores \citep{kato2018autoware}. También existen soluciones propietarias integradas en
...
\citep{sucan2012ompl} o integrando los componentes mediante otros middleware
robóticos. Los algoritmos
...
como \texttt{explore\_lite} representan ejemplos de este enfoque
\citep{horner_mexplore}. Su
...
propias \citep{michel2004webots,rohmer2013coppeliasim}, mientras que Isaac
Sim incorpora capacidades avanzadas de representación gráfica, generación de
