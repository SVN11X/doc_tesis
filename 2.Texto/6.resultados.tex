...
válidas. De ellas, 59 alcanzaron la etapa de ejecución. Respecto de su resultado
final, 54 metas fueron abortadas, una fue completada exitosamente y cinco
quedaron sin un resultado terminal al finalizar los registros.

Considerando el total de metas generadas, la proporción de metas completadas
exitosamente fue de aproximadamente 1.7%. Este valor caracteriza
específicamente el desempeño del sistema para completar las metas individuales
de navegación y no corresponde a una tasa de éxito global de la exploración.

La elevada proporción de metas abortadas evidencia una limitación importante en
la robustez de la navegación bajo las condiciones del ensayo. Sin embargo, esta
limitación coexistió con ejecuciones de exploración en las que el robot continuó
incorporando información del entorno y produjo mapas válidos.
...
de navegación termina en aborto o cuando se supera el tiempo máximo sin
progreso configurado. El mensaje de lista agotada aparece únicamente
...
La elevada proporción de metas abortadas impide interpretar estos ensayos como
evidencia de navegación robusta hacia las fronteras. El resultado se conserva
como una limitación cuantificada del desempeño obtenido en el entorno
experimental. En la Fig.~\ref{fig:nav_exploracion_real} se muestran dos instantes representativos de una ejecución de navegación y exploración sobre hardware real, desde un mapa parcial hasta la mayor cobertura alcanzada.
...
Cinco de seis ejecuciones produjeron mapas válidos de manera autónoma.
Cobertura libre media de 62.2\% y área libre mapeada media de
3.50~m$^2$ \\
