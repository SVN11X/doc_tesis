...
\addutem{0.48}{2.Texto/Imag/prueba_real_navegacion_y_exploracion_parte1.png}{Mapa parcial en una etapa temprana de la exploración.}
\hfill
\addutem{0.48}{2.Texto/Imag/prueba_real_navegacion_y_exploracion_parte4.png}{Mayor cobertura con ruta planificada hacia la frontera seleccionada.}
\end{utemMultiFigurePropia}
