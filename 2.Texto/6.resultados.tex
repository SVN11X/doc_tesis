...
Sec.~\ref{sec:alcances} y no se ensayó, por lo que este trabajo no informa
...
Nav2 & Verificada funcionalmente, resultado de metas cuantificado & Distribución de resultados de 55 metas terminales de exploración (Tabla~\ref{tab:anx_explore_metas}). El protocolo con metas fijas queda fuera del alcance (Sec.~\ref{sec:alcances}) \\
