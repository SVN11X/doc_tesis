...
\textit{Cumplido parcialmente.} El mapeo y la localización se implementaron
mediante \texttt{slam\_toolbox} y se verificaron funcionalmente en hardware
real, con caracterización cuantitativa de cobertura y área libre. Nav2 quedó
integrado y verificado funcionalmente mediante las metas generadas durante la
exploración, cuyo resultado se cuantificó. El carácter parcial proviene del
desempeño alcanzado en esa navegación, con 54 metas abortadas de 60 generadas.
La navegación dirigida con metas fijas definidas por el operador y la
localización sobre un mapa almacenado con AMCL no forman parte del alcance
declarado en la sección \hyperref[sec:alcances]{Alcances y limitaciones}.
