...
\texttt{diff\_drive\_controller}. Sin embargo, la ley discreta heredada de
\texttt{ROSArduinoBridge}, denominada PID en su implementación original, no
corresponde a una realización PID estándar, como se detalla en la
Sec.~\ref{sec:motorcontrol_pid}.
