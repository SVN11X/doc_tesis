...
La selección del backend según el entorno —\texttt{DiffDriveArduino} en hardware real y Gazebo en simulación, conservando marcos, tópicos y parámetros geométricos— se detalla en la Sec.~\ref{sec:backend} y el Cap.~\ref{chap:robot_real}.
