...
\texttt{orientation\_scale} & 0.0 & Desactiva el término de orientación \\
\texttt{min\_frontier\_size} & 0.05~m & Tamaño mínimo de una frontera válida \\
\texttt{resolution} & 0.05~m/celda & Resolución usada para evaluar el costo \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{algorithmic}[1]
\footnotesize
\Require \texttt{global\_costmap} $C$; pose del robot; configuración de la Tabla~\ref{tab:explore_params_ch9}; acción \texttt{NavigateToPose} de Nav2.
