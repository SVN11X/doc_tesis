...
Se adopta el módulo L298N como puente H dual por su disponibilidad, bajo costo y compatibilidad lógica a 5~V con el \gls{Arduino} \citep{STMicro_L298N_Datasheet}. Entrega hasta 2~A continuos por canal. En la implementación final, los pines de habilitación ENA y ENB se mantienen en estado HIGH, mientras que la velocidad y el sentido de giro se controlan aplicando \gls{PWM} sobre los pines de dirección IN1--IN4; sus especificaciones completas se incluyen en el \ref{anx:componentes}. Su zona muerta constituye una de las no linealidades que el refinamiento experimental del controlador PID compensa, tal como se anticipó en el Capítulo~\ref{marco_teorico}.
